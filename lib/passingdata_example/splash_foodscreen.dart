  ...
  void initState(){
    ...
    Timer(Duration(seconds: 5), () {
      Navigator.pushReplacement(context as BuildContext,
          MaterialPageRoute(builder: (context) => foodlogin()));
    });
}
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Text("FOODIE'S CORNER",style:GoogleFonts.alata(fontSize: 22),),
              ),
              SizedBox(height: 20,),
              ...
              SizedBox(height: 10,),
              Text("All spicy foods available here..",style: GoogleFonts.alata(fontSize: 15,color: Colors.black),),
            ],
          ),
        ),
      ),
