...
class _WithBuilder extends State<WithBuilder> {
  ...
  List<ItemData> data = [
    ItemData(Colors.blue, "assets/img_2.png", "Hi", "It's Me", "ANU"),
    ItemData(Colors.deepPurpleAccent, "assets/img_2.png", "Take a", "Look At",
        "Liquid Swipe"),
    ItemData(Colors.green, "assets/img_2.png", "Liked?", "Fork!", "Give Star!"),
    ItemData(Colors.yellow, "assets/img_2.png", "Can be", "Used for",
        "Onboarding design"),
    ItemData(
        Colors.pink, "assets/img_2.png", "Example", "of a page", "with Gesture"),
    ItemData(Colors.red, "assets/img_2.png", "Do", "try it", "Thank you"),
  ];
